...
<path d="M85.191348 938.808652V0H0v1024h1024v-85.191348H85.191348z" fill="#4F4A4A" p-id="4040"></path><path d="M412.326123 495.813644L711.347754 613.377704l295.613976-462.589018-72.412645-46.003328-257.27787 403.806988-298.169717-117.56406-270.908486 413.178037 70.708818 46.003328 233.424293-354.396007z" fill="#4F4A4A" p-id="4041">
  ...
  addBlock('mj-text', {
    ...
    content: '<mj-section><mj-text>Content 1</mj-text></mj-section>',
    activate: true,
  });
  ...
  addBlock('mj-button', {
    ...
    content: '<mj-section><mj-button>Button</mj-button></mj-section>',
  });
  ...
  addBlock('mj-image', {
    ...
    content: `<mj-section><mj-image src="${imagePlaceholderSrc}"/></mj-section>`,
    activate: true,
  });
  ...
  addBlock('mj-divider', {
    ...
    content: '<mj-section><mj-divider/></mj-section>',
  });
  ...
  addBlock('mj-spacer', {
    ...
    content: '<mj-section><mj-spacer/></mj-section>',
  });
